...
# Modified function: removed the drawing of the bounding box
...
title_path = "corpus/Title_text.txt"
...
output_dir = "E:/Text_Line_Data1/images"
os.makedirs(output_dir, exist_ok=True)

output_dir1 = "E:/Text_Line_Data1/labels"
...
for i, paragraph,title in enumerate(zip(paragraphs,titles), start=1):
    # Reset yolo_boxes for each new image so annotations don't carry over.
    yolo_boxes = []
    ...
    header1_bbox = draw_text_without_bbox(draw, (header1_x, header1_y), header1, font=font_header1, fill=header_color, label="text")
    ...
    start_x, start_subtitle_y = 150, subtitle_y + 100
    line_spacing = 15
    ...
    # rgb_image.save(output_path, format="JPEG", quality=15, optimize=True)
    ...
    print(f"✅ Image processed (without drawn bounding boxes) saved at: {output_path}")
