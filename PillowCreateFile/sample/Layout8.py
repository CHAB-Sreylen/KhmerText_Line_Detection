...
text_title = 'ការដាក់ដំណើរការម៉ាសុីនបកប្រែ TranslateKH ជំនាន់ទី១'
...
draw.rectangle((stamp_x, stamp_y, stamp_x + 300, stamp_y + 300), outline=(255, 0, 0), width=2)
...
Date_x,Date_y =150, info_qr_y +300
font_text_qr = ImageFont.truetype(font_MPTC, text_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), text_qr, font=font_text_qr, fill=text_color)


text_qr = 'https://cdsr.co/enskh'
Date_x,Date_y =700, info_qr_y +300
font_text_qr = ImageFont.truetype(font_MPTC, text_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), text_qr, font=font_text_qr, fill=text_color)

text_qr = 'https://cdsr.co/enskh'
Date_x,Date_y =1200, info_qr_y +300
font_text_qr = ImageFont.truetype(font_MPTC, text_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), text_qr, font=font_text_qr, fill=text_color)

text_qr = 'https://cdsr.co/enskh'
Date_x,Date_y =1700, info_qr_y +300
font_text_qr = ImageFont.truetype(font_MPTC, text_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), text_qr, font=font_text_qr, fill=text_color)
...
Date_x,Date_y =150, Date_y+70
font_footer_text = ImageFont.truetype(font_SiemReap, footer_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), footer_text, font=font_footer_text, fill=text_color)

footer_text = '123   023 724 810'
Date_x,Date_y =2000, Date_y - 95
font_footer_text = ImageFont.truetype(font_SiemReap, footer_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), footer_text, font=font_footer_text, fill=text_color)


footer_text = 'www.mptc.gov.kh'
Date_x,Date_y =2000, Date_y+70
font_footer_text = ImageFont.truetype(font_SiemReap, footer_font_size)
draw_text_with_bbox(draw, (Date_x, Date_y), footer_text, font=font_footer_text, fill=text_color)


output_path = "output/Layout_with_bounding_boxes8.png"
