...
output_dir = "E:/Text_Line_Data/images"
os.makedirs(output_dir, exist_ok=True)

output_dir1 = "E:/Text_Line_Data/labels"
...
for i, paragraph in enumerate(paragraphs, start=1):
    ...
    header1_bbox = draw_text_without_bbox(draw, (header1_x, header1_y), header1, font_header1, fill=header_color, label="header")

    header2_y = header1_bbox[3] + 20
    header2_x = (a4_width_px - draw.textlength(header2, font=font_header2)) / 2
    header2_bbox = draw_text_without_bbox(draw, (header2_x, header2_y), header2, font=font_header2, fill=header_color, label="header")
    ...
    confirm_bbox = draw_text_without_bbox(draw, (confirm_x, confirm_y), confirm_text, font=font_confirm_text, fill=header_color, label="header")
    ...
    draw_text_without_bbox(draw, (title_x, title_y), text_title, font=font_text_title, fill=text_color, label="text")
