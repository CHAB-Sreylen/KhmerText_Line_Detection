...
text_qr_instruction = 'សូមស្គេន QR Code ដើម្បីចុះឈ្មោះ និងអានព័ត៌មានបន្ថែម'
qr_instruction_y = title_y + 300
qr_instruction_x = 150
font_text_qr = ImageFont.truetype(font_MPTC, text_font_size)
draw_text_with_bbox(draw, (qr_instruction_x, qr_instruction_y), text_qr_instruction, font=font_text_qr, fill=text_color)

# QR Code Links
qr_link_1 = 'https://cdsr.co/enskh'
qr_link_1_y = qr_instruction_y + 460
qr_link_1_x = 150
draw_text_with_bbox(draw, (qr_link_1_x, qr_link_1_y), qr_link_1, font=font_text_qr, fill=header_color)

qr_link_2 = 'https://cdsr.co/enskh'
qr_link_2_y = qr_instruction_y + 460
qr_link_2_x = 700
draw_text_with_bbox(draw, (qr_link_2_x, qr_link_2_y), qr_link_2, font=font_text_qr, fill=header_color)

# Footer Line
draw.line([(150, qr_link_1_y + 130), (2330, qr_link_1_y + 130)], fill=header_color, width=1)

# Footer Texts
footer_text_1 = 'អគារលេខ១៣ មហាវិថីព្រះមុនីវង្ស សង្កាត់ស្រះចក'
footer_text_2 = 'ខណ្ឌដូនពេញ រាជធានីភ្នំពេញ 120210'
footer_text_3 = '123   023 724 810'
footer_text_4 = 'www.mptc.gov.kh'

footer_font = ImageFont.truetype(font_SiemReap, footer_font_size)
footer_y_start = qr_link_1_y + 150

# Footer Left Side
draw_text_with_bbox(draw, (150, footer_y_start), footer_text_1, font=footer_font, fill=header_color)
draw_text_with_bbox(draw, (150, footer_y_start + 60), footer_text_2, font=footer_font, fill=header_color)

# Footer Right Side
draw_text_with_bbox(draw, (2000, footer_y_start), footer_text_3, font=footer_font, fill=header_color)
draw_text_with_bbox(draw, (2000, footer_y_start + 60), footer_text_4, font=footer_font, fill=header_color)
